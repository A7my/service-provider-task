                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input name="description"  type="text" class="form-control" aria-label="Default" aria-describedby="inputGroup-sizing-default">
                            @error('description')
                                <p style="color:red">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <p>service image</p>
                        <br>
                        <input type="submit" value="create" style="margin:auto" class="btn btn-warning">
