...
{{-- ============================================================== --}}
                        ...
                        <h2 style="margin: auto">Customers</h2>
                        </div>
                            ...
                            <tbody>
                                ...
                                <td>
                                    @if ($o->account_status == 'active')
                                        <p style="color: rgb(10, 255, 10)">active</p>
                                    @endif
                                    @if ($o->account_status == 'inactive')
                                        <p style="color: rgb(255, 5, 5)">inactive</p>
                                    @endif

                                    <form action="{{url('serviceProvider/change' , $o->id)}}" method="POST">
                                        @csrf
                                        <select name="status" id="" class="btn btn-success">
                                            <option value=""> -- choose another status -- </option>
                                    ...
                                    <td>
                                        <form action="{{url('serviceProvider/delete' , $o->id)}}" method="POST">
                                            @csrf
                        ...
                        @if(Session::has('delete_s_p'))
                        <div class="alert alert-danger" role="alert">
                            {{Session::get('delete_s_p')}}
                        </div>
                        @endif
                    </div>
                    <!-- Content Row -->
